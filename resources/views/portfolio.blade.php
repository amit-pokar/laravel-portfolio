...
@section('title', (($fullName ?? null) ?: (trim(($user->first_name ?? '') . ' ' . ($user->last_name ?? '')) ?: $user->name)) . ' - Portfolio')
...
@section('content')
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">
            ...
            <span class="d-none d-lg-block"><img class="img-fluid img-profile rounded-circle mx-auto mb-2" src="{{ $user->profile_photo_url }}" alt="{{ $fullName }}" /></span>
        </a>
    ...
    <div class="container-fluid p-0">
            ...
            <section class="resume-section" id="about">
                <div class="resume-section-content">
                    ...
                    {{-- addressLine provided by controller --}}
                    ...
                    @if (! empty($user->professional_summary))
                        <p class="lead mb-5">{!! nl2br(e($user->professional_summary)) !!}</p>
                    @endif
                    @if ($socialEngagements->isNotEmpty())
                        <div class="social-icons">
                            @foreach ($socialEngagements as $socialEngagement)
                                <a class="social-icon" href="{{ $socialEngagement->link }}" target="_blank" rel="noopener noreferrer" aria-label="{{ $socialEngagement->name }}">
                                    <i class="{{ $socialEngagement->icon_class ?: 'fas fa-link' }}" aria-hidden="true"></i>
                                </a>
                            @endforeach
                        </div>
                    @endif
